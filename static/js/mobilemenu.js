...
<body>
    <!-- Скрытый элемент для хранения URL-адресов -->
    <div id="urls" 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="menu-grid">
                    ...
                    <div class="menu-item" onclick="window.location.href='{{ url_for('user.accounts') }}'">
                        <i class="fas fa-wallet"></i>
                        <span>ანგარიშები</span>
                    </div>
    ...
    <script>
        ...
        async function checkBalanceUpdate() {
            ...
            try {
                ...
                // Reload page if balance changed
